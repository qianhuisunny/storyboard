        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-1 flex items-center gap-2">
              <Code className="w-5 h-5 text-[#7C6A56]" />
              Final Output (JSON)
            </h2>
          ...
          <div className="mt-6 p-4 bg-muted/20 rounded-lg border border-border">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">screen_number</span>
                <span className="text-muted-foreground ml-2">number</span>
              </div>
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">screen_type</span>
                <span className="text-muted-foreground ml-2">string</span>
              </div>
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">duration</span>
                <span className="text-muted-foreground ml-2">number</span>
              </div>
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">voiceover_text</span>
                <span className="text-muted-foreground ml-2">string</span>
              </div>
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">visual_direction</span>
                <span className="text-muted-foreground ml-2">string | string[]</span>
              </div>
              <div className="p-2 bg-background rounded">
                <span className="font-mono text-[#7C6A56]">text_overlay</span>
                <span className="text-muted-foreground ml-2">string?</span>
              </div>
            </div>
          </div>
