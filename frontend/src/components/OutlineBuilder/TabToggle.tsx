...
/**
 * TabToggle - Three-tab navigation for OutlineBuilder.
 */
export default function TabToggle({ activeTab, onChange }: TabToggleProps) {
  ...
  return (
    <div
      role="tablist"
      aria-label="Outline Builder Views"
      ...
      {tabs.map((tab, index) => {
        ...
        return (
          <button
            ...
            role="tab"
            id={`outline-tab-${tab.key}`}
            aria-selected={isActive}
            aria-controls={`outline-tabpanel-${tab.key}`}
