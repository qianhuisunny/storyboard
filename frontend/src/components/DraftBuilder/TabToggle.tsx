...
const tabs: { key: TabKey; label: string; icon: React.ReactNode }[] = [
  { key: "user", label: "Visual Editor", icon: <Pencil className="w-4 h-4" /> },
...
/**
 * TabToggle - Three-tab navigation for the Draft Builder.
 * Switches between Visual Editor, Processing log, and JSON Output views.
 */
