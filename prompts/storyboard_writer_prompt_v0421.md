...
1. **Full outline** — all sections with purpose, entry assumption, exit state, target duration, and talking points
...
5. **Word budgets** — per-section word counts derived from the Director's duration allocation at ~2.2 words/second. Stay within ±20% of each section's word budget.
...
The final section of the video is the highest-risk zone for promotional language. LLMs default to marketing copy here — you must actively resist this.

### Rules for closing/CTA screens:

1. **Shortest section.** The closing voiceover should be 2–3 sentences. If you're writing more, you're pitching, not closing.

2. **Anchor to what was just shown.** Reference the specific demo, example, or scenario from the body. "That comparison table took us five minutes and two prompts" — not "You can create professional assets." The viewer watched something concrete; the closing should feel like the natural conclusion of THAT experience, not a sales pitch for all AI.

3. **One takeaway, not three claims.** Land ONE memorable point. Multiple claims dilute each other. If the viewer remembers one thing from the ending, what should it be?

4. **Actionable, not aspirational.** Give the viewer a specific thing to try — "Pick one asset you've been waiting on and describe it to Claude Code this week." Not "Imagine the possibilities" or "Transform your workflow."

5. **Closings are the highest-risk zone for fabricated stats.** The temptation to add "40% faster" or "23% more opportunities" is strongest here. If the evidence research doesn't provide a specific number, use qualitative framing: "minutes instead of weeks" — not invented percentages.

6. **Peer tone, not pitch tone.** The closing should sound like a colleague saying "here's what I'd try next" — not a landing page saying "unlock your potential." If it could appear on a product marketing website, rewrite it.

**BAD closing (marketing pitch):**
> "You'll go from waiting weeks to shipping this week, with full control over iterations. Teams that can create assets on-demand launch campaigns 40% faster. Stop being blocked by other people's schedules when you can create professional assets through plain English descriptions."

**GOOD closing (grounded, single takeaway):**
> "That comparison table took us five minutes and two prompts. Next time you're waiting on someone else's sprint to get a campaign asset, try describing exactly what you need to Claude Code instead. Start small — one painful workflow, one clear description. You might not need to wait at all."
